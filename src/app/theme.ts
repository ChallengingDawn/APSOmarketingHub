...
const theme = createTheme({
  ...
  typography: {
    ...
    h4: { fontFamily: "var(--font-outfit), var(--font-inter), sans-serif", fontWeight: 600, letterSpacing: "-0.03em", color: "#1a1d21" },
    h5: { fontFamily: "var(--font-outfit), var(--font-inter), sans-serif", fontWeight: 600, letterSpacing: "-0.025em", color: "#1a1d21" },
    h6: { fontFamily: "var(--font-outfit), var(--font-inter), sans-serif", fontWeight: 600, letterSpacing: "-0.015em", color: "#1a1d21" },
