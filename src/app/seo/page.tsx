  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="Keyword intelligence, content gaps & ranking opportunities — illustrative sample data; live Search Console integration is planned"
      />
          ...
          <Card variant="outlined" sx={{ height: "100%" }}>
            <CardContent>
              ...
              >
                ...
                >
                  <Typography variant="caption" color="text.secondary">
                    Illustrative example of the planned SEO reasoning pipeline &middot; goes live with the Search Console integration
                  </Typography>
                </Box>
              </Box>
            </CardContent>
