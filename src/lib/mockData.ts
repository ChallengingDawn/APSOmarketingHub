...
export const contentProposals: ContentProposal[] = [
  ...
  /* ── Newsletter (5) — full email format ── */
  {
    ...
    text: "📬 Subject: Q2 at APSOparts — what's new in sealings & plastics\n\nHi {first_name},\n\nSpring is here and so is a fresh batch of products in our catalog to help you build better, seal tighter, and ship faster.\n\n— What's new this quarter —\n\n🔹 FFKM o-ring range\nUltra-high chemical resistance for the most demanding aggressive media. Standard sizes shipping from stock in 48h.\n\n🔹 Expanded PEEK catalog\n40+ new PEEK rod and sheet references for aerospace, semiconductor and medical applications. Full material traceability.\n\n🔹 POM-C stock expanded\nRod (Ø6 to Ø300 mm) and sheet (1 to 50 mm) now in stock across all standard dimensions. No more 6-week lead times.\n\n— Free technical resources —\nNew datasheets, chemical compatibility tables and material guides — all downloadable from the APSOparts product pages.\n→ Browse the catalog\n\n— Request samples —\nTest materials on your own bench before committing. Free samples for qualified projects.\n→ Request samples\n\nTo your next perfect seal,\nThe APSOparts Team",
  ...
  },
  {
    ...
    text: "📬 Subject: The 5 questions that determine your o-ring material\n\nHi {first_name},\n\nA great design, the wrong elastomer, and a seal that fails after 3 months in service — we see it all the time. The right material is rarely the most expensive; it's the one that matches your application.\n\nWe've put together a free guide that walks through the 5 questions to answer before specifying:\n\n1️⃣ What's the operating temperature range?\n2️⃣ What media will the seal contact?\n3️⃣ Static or dynamic application?\n4️⃣ What pressure & duty cycle?\n5️⃣ Any compliance requirements (FDA, USP, EU 1935)?\n\nThe guide includes a temperature/chemical compatibility matrix for FKM, FFKM, EPDM, NBR, and Silicone — printable for your reference.\n\n→ Download the free guide (PDF)\n→ Browse the APSOparts o-ring catalog\n→ Request free samples to test on your bench\n\nUntil next time,\nThe APSOparts Team",
